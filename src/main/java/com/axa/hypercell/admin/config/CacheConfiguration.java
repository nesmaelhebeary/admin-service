package com.axa.hypercell.admin.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("adminservice");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("adminservice");
        ...
        config.getMapConfigs().put("com.axa.hypercell.admin.domain.*", initializeDomainMapConfig(jHipsterProperties));
