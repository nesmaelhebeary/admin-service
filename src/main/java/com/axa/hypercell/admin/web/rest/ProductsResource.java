...
public class ProductsResource {
    ...
    public ResponseEntity<Products> partialUpdateProducts(
        ...
        Optional<Products> result = productsRepository
            ...
            .map(
                existingProducts -> {
                    if (products.getLineTypeId() != null) {
                        existingProducts.setLineTypeId(products.getLineTypeId());
                    }
                    if (products.getNameEn() != null) {
                        existingProducts.setNameEn(products.getNameEn());
                    }
                    if (products.getNameAr() != null) {
                        existingProducts.setNameAr(products.getNameAr());
                    }
                    ...
                    if (products.getIsAllowMultipleSections() != null) {
                        existingProducts.setIsAllowMultipleSections(products.getIsAllowMultipleSections());
                    }
